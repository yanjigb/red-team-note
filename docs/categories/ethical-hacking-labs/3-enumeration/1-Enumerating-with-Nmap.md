...
First of, I will use the `ping` command on a given subnet range, to check if the hosts are alive. 
...
```
Is more convenient to take the user's input on the first three octets and the last octet is the loop (1 - 254).
