...
4. Add the target domain to perform a network recon:
`db insert domains`
`certifiedhacker.com`
...
Some require you to pay money, which will be mentioned below. I suggest as you go along, you save all the API keys to a file so you can use them later. To setup an API key to your recon-ng is very simple, just follow the document below, and manage your keys inside Recon-ng using: `keys` command.
...
3. Add a new workspace named recon:
